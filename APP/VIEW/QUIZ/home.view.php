...
<body class="relative text-[clamp(0.8rem,1.3vw,1rem)]">
            ...
            <ul class="xcenter flex justify-between items-center gap-4 p-4 hidden md:flex">
                ...
                <li>
                    <a href="<?= ROOT ?>/public/students/leaderboard"
                        class="flex gap-2 justify-center item-center text-black hover:text-blue-500 truncate">
                        <i class="ri-bar-chart-fill text-[1.6em] lg:text-[1em]"></i> <span
                            class="hidden lg:block">Leaderboard</span>
                    </a>
                </li>
            </ul>

            <div class="cta-buttons flex justify-between items-center gap-2 p-2 ">
                <a href="<?= ROOT ?>\public\auth\logout"
    ...
    <section id="hero" class="py-4 min-h-screen flex flex-col items-center justify-center">
        <div id="quiz-config" class="flex flex-col items-center justify-start">
            ...
            <form action="" method="post" class="border-2 border-gray shadow-lg rounded-lg bg-white flex justify-center items-center flex-col p-4">
                ...
                <div class=" w-full p-4 my-2 flex justify-center items-center gap-2 flex-col md:flex-row">
                    ...
                    <select name="category" class="border-2 border-orange-600 px-8 py-4 active:border-orange-600  focus:border-orange-600 py-2 px-4 rounded-lg  w-full flex justify-center items-center">
                ...
                <div class=" w-full p-4 my-2 flex justify-center items-center gap-2 flex-col md:flex-row">
                    ...
                    <div class="w-full flex justify-center items-center gap-4">
                        ...
                        <label class="btn w-fit hover:bg-orange-600 hover:text-white" for="medium"><i class="ri-game-fill text-[1.2em]"></i> Medium</label>

                        <input class="radio-elm" type="radio" name="difficulty" value="hard" id="hard">
                        <label class="btn w-fit hover:bg-orange-600 hover:text-white" for="hard"><i class="ri-game-2-fill text-[1.2em]"></i> Hard</label>
                    </div>
                    
                </div>

                <button class="btn btn-primary font-bold w-fit px-8" type="submit"><i class="ri-play-large-fill"></i> Start Quiz</button>
            </form>
        </div>
    </section>
